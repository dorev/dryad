...
const static std::map<ChordIntervals, ChordQualities> __chordsTypes
({
 { {3,4}    , { ChordTriad::Minor,  ChordExtension::None        } },
...
std::string toString(const ChordTriad& input)
{
  switch(input)
  {
    case ChordTriad::Major : return "";
    case ChordTriad::Minor : return "m";
    case ChordTriad::Aug : return "+";
    case ChordTriad::Dim : return "-";
    case ChordTriad::Sus2 : return "sus2";
    case ChordTriad::Sus4 : return "sus4";
    default : return "";
  }
}
...
std::string toString(const ChordExtension& input)
{
  switch(input)
  {
    case ChordExtension::HalfDim :     return "half-dim";
    case ChordExtension::Six :         return "6";
    case ChordExtension::Seven :       return "7";
    case ChordExtension::MajorSeven :  return "M7";
    default : return "";
  }
}
